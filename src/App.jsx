...
import About from "./FeaturesProject/Features";
...
function TechStack() {
  return (
    <div className="pt-14 text-white">
      ...
      <div className="mt-20 container mx-auto bg-gradient-to-l from-amber-950 to-gray-950 shadow-lg py-6 overflow-hidden">
